...
> **Performance Note**: Setup typically takes 2-3 seconds, test execution ~12 seconds for all 95 tests
...
This starter includes a comprehensive testing framework with 95 integration tests.
...
# Run all tests (95 integration tests) - takes ~12 seconds
cargo nextest run
