...
graph TD
    subgraph "🧪 Testing Strategy for Web Applications"
        ...
        INTEGRATION[🔌 Integration Tests<br/><b>Main focus - 182 tests</b><br/>~90% of tests<br/>💡 HTTP + Database + Business Logic]
...
# Run all tests (182 tests, ~21 seconds)
cargo nextest run
...
With 182 tests, this saves significant development time.
...
1. **Run the Tests**: `cargo nextest run` to see all 182 tests pass
