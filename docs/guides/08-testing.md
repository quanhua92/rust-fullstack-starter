...
graph TD
    subgraph "🧪 Testing Strategy for Web Applications"
        ...
        INTEGRATION[🔌 Integration Tests<br/><b>Main focus - 137 tests</b><br/>~90% of tests<br/>💡 HTTP + Database + Business Logic]
...
# Run all tests (137 tests, ~17 seconds)
cargo nextest run
...
With 137 tests, this saves significant development time.
...
1. **Run the Tests**: `cargo nextest run` to see all 137 tests pass
