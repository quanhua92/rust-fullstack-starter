...
graph TD
    subgraph "🧪 Testing Strategy for Web Applications"
        ...
        INTEGRATION[🔌 Integration Tests<br/><b>Main focus - 157 tests</b><br/>~90% of tests<br/>💡 HTTP + Database + Business Logic]
...
# Run all tests (157 tests, ~20 seconds)
cargo nextest run
...
With 157 tests, this saves significant development time.
...
1. **Run the Tests**: `cargo nextest run` to see all 157 tests pass
