...
export interface paths {
	...
	"/api/v1/monitoring/incidents/{id}": {
		...
		/** Get incident by ID */
		get: operations["get_incident_by_id"];
	...
	"/api/v1/monitoring/incidents/{id}/timeline": {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		get: operations["get_incident_timeline"];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	"/api/v1/monitoring/stats": {
		...
		get: operations["get_monitoring_stats"];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
...
export interface operations {
	...
	get_alerts: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApiResponse_Vec_Alert"];
				};
			};
			/** @description Unauthorized */
			401: {
	...
	get_incidents: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApiResponse_Vec_Incident"];
				};
			};
			/** @description Invalid query parameters */
			400: {
	...
	update_incident: {
		...
		responses: {
			...
			/** @description Forbidden - requires moderator role or incident ownership */
			403: {
				headers: {
					[name: string]: unknown;
				};
	...
	get_incident_timeline: {
		parameters: {
			query?: {
				...
				offset?: number;
				/** @description Hours to look back before incident start (default: 1) */
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApiResponse_IncidentTimeline"];
				};
			};
			/** @description Invalid query parameters */
			400: {
	...
	get_metrics: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApiResponse_Vec_Metric"];
				};
			};
			/** @description Invalid query parameters */
			400: {
	...
	get_monitoring_stats: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApiResponse_MonitoringStats"];
				};
			};
			/** @description Unauthorized */
			401: {
