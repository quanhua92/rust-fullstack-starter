				...
				<CardContent>
					...
					<div className="mt-2">
						<Progress
							value={
								basicHealthQuery.data?.data?.uptime
									? getUptimePercentage(basicHealthQuery.data.data.uptime)
									: 0
							}
							className="h-2"
						/>
			...
			<Card>
				...
				<CardContent>
					<div className="flex items-center space-x-2">
						{detailedHealthQuery.data?.data?.checks?.database?.status ===
						"healthy" ? (
					...
					<p className="text-xs text-muted-foreground mt-2">
						{detailedHealthQuery.data?.data?.checks?.database?.message ||
							"Checking connection..."}
					</p>
				</CardContent>
			</Card>
						...
						<div className="grid grid-cols-2 md:grid-cols-5 gap-4">
							...
							<div className="text-center">
								<div className="text-2xl font-bold text-red-600">
									{(taskStatsQuery.data?.data?.failed || 0) +
										(taskStatsQuery.data?.data?.cancelled || 0)}
								</div>
