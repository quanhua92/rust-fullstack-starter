		...
		() => [
			{
				...
				icon: Heart,
				color:
					getCurrentHealthScore() > 90
						? "#10B981"
						: getCurrentHealthScore() > 70
							? "#F59E0B"
							: "#EF4444",
				trend: "+2.5%",
			},
			...
			},
			{
				...
				icon: Server,
				color:
					basicHealthQuery.data?.data?.status === "healthy"
						? "#10B981"
						: "#EF4444",
				trend: "+1.2%",
			},
			{
				...
				icon: Clock,
				color:
					getUptimePercentage() > 99
						? "#10B981"
						: getUptimePercentage() > 95
							? "#F59E0B"
							: "#EF4444",
				trend: "+0.1%",
			},
		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Database vs API health over time</CardDescription>
					</CardHeader>
					<CardContent>
						<ResponsiveContainer width="100%" height={300}>
							<LineChart data={healthTrendData}>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>API response time trends (ms)</CardDescription>
					</CardHeader>
					<CardContent>
						<ResponsiveContainer width="100%" height={300}>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Real-time system health information</CardDescription>
				</CardHeader>
				<CardContent>
					...
					<div className="mt-6 pt-4 border-t text-xs text-muted-foreground">
						Data refreshes automatically every 5-10 seconds. Last updated:{" "}
