...
- **Comprehensive**: 149 tests covering all functionality including user management, monitoring, and metadata persistence
...
```bash
./scripts/test-with-curl.sh             # 81 endpoint tests including monitoring APIs (~8 seconds)
